...
<!-- ======= Footer ======= -->
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                <strong>Phone:</strong> +91 7020009117<br>
                <strong>Email:</strong>  info@royalrichs.com<br>
              </p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">ALGO/ROBO/MT4</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">TRAINING & WORKSHOP</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">DEMATE A/C (ALICE BLUE)</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">DONATE PLANTS & HELP NEEDY</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
          	<a href="https://api.whatsapp.com/send?phone=+917020009117" title="Whatspp" target="_blank" rel="noopener noreferrer">
          	<img src="https://royalrichs.com/wp-content/uploads/2020/05/whatsapp.png" style="width:30px;vertical-align:middle;"><b>Chat with us</b></a>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>RoyalRichs</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
